...
public class Util {
    ...
    public static String formatFullName(String firstName, String lastName){//formats two names and returns full name
    ...
    public static Character[] combine2Arrays(Character[] arr1, char[] arr2){
